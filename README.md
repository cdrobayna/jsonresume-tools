...
lint it. No install, no setup needed:
...
| [`jsonresume-tailor`](./packages/tailor) | `jrt`: generates role-tailored variants (backend, devops, sysadmin, ...) of a resume from a single annotated base resume. | [![npm](https://img.shields.io/npm/v/jsonresume-tailor.svg)](https://www.npmjs.com/package/jsonresume-tailor) |
...
All four packages (`jsonresume-parity`, `jsonresume-tailor`, `jsonresume-lint`, and
